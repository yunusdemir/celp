...
def test_get_friends_by_user_id():
    assert data.get_friends_by_user_id("Vsp7ncZY-sm1gzkyNcld_A"), ['KbduTqKt1AuQ-YJaKD_C7A',
                                                                   'cgG1Gf8nhS2WlVCe-EUVMQ',
                                                                   'u-F1PfnPgWbVBzQe4a3DNA',
                                                                   'UieSEe9S5e9OOrwZkeXQNQ',
                                                                   'YOQFZW4L_6U98gIu_MiPOA',
                                                                   'EZ1xB7-tNA9Rk0UwYR6jrw',
                                                                   'P9SzYFU_gsb2kz9gs6gZIQ',
                                                                   'zMuoIkLntiVGKR0oGWxhCg',
                                                                   'TVMhp7IZmG-yk6bZo5LlxQ',
                                                                   'lDCdZzcWuIbGa3D18Lvmsg',
                                                                   'ybsVt_8I5scPdXU_DTvzWg',
                                                                   'i12QU950hek3ReJoWcq3jg',
                                                                   'sO0c1oNjaESBdnVbkLzQ9A',
                                                                   'WWBpma7wXT64tH1MWMIpQg',
                                                                   '48GKxvCCE0AVM1CFMhxs6Q',
                                                                   'ZlwaW1me_3iq8uHzdgYIdg',
                                                                   'oF_1LC0zuzXD_ef-C7wLYg',
                                                                   'Xtif85mmu024k34PxUpmuA',
                                                                   '7aNFwP5QJZYU-vKPf55myQ',
                                                                   'XkJQwZIGikBZn9_zqW1wDw',
                                                                   'ucPd8XDHTvtFLZYg7ZJ6Hg',
                                                                   'rbEcEj3B0ghF6zjHkExBFw',
                                                                   '3_jU6ulXkdQckSwQJjYUnw',
                                                                   'AocCwPeEvpEQ6_D6cEyooA',
                                                                   'GAmNZcD_WMT42ZRFM6JKAA',
                                                                   'TuBywMpiJbEix5b5j6bgkA',
                                                                   'Q030a12hDz_j0xnIpF5F-A',
                                                                   'DA7LdReRpZ4PO3MkcKyBNQ',
                                                                   'wiexA3xfvRkniy-4_5uQVg',
                                                                   '6uNn2ApBB_rTUK8JrHA4BQ',
                                                                   'ikBp8rXvo1yEcrHnixDP7A',
                                                                   'D0X0Gvr5Va7LvNAxbrOm2w',
                                                                   'K3MvRJ3Erk1qMRA7bi0u-g',
                                                                   '8b6_gjxPG_yo8GsEwWDegQ',
                                                                   'ZsP1qLUKc4EeGSkCnDkB_w',
                                                                   'sdgk2YP5YLYfTamjqS0NGA',
                                                                   'Xk3g8xYP_9N03j0vuZMCcQ',
                                                                   'Av8KQ40S7yUSwwH4xAGbxw',
                                                                   'qt5_SUXXvsoi0ifuabVscg',
                                                                   'vPjbf6jyKP8eJUMtVg2IhQ',
                                                                   'xn2Hx_PRyvOdtD1nIGe21w',
                                                                   'eaw1c9XK9z1Ush3RlbNXBw',
                                                                   'xZpQEd-dmwP9Skc-64YTgQ',
                                                                   'UY-ZR1euTr131Mc3M-dRyw',
                                                                   'D96hPkulOXSAaCEJkG8Uug',
                                                                   '66O30REf4Lyx7Ge0x9M_qA',
                                                                   'vdjvOXMnQii5RG0XqO0rMA',
                                                                   '2VJgxZ-uyggq2slogYbzPA',
                                                                   'BgO5JP4IYCUOjN5aZoStnQ',
                                                                   'pSfQYCwXWuyo2bvWe4847w',
                                                                   'Znmjg0FaPHxk2UimZG4QQg',
                                                                   '4l97YDkTBwZ2XLsw9wRVfQ',
                                                                   'LGi6LhMW4LOkE2lawTdKIQ',
                                                                   'BWEZfoESq3aq5pPjHMDhFQ',
                                                                   'VGY69c67ZYeQyTjI-4GJqg',
                                                                   'btNEUpTHccwBgLg6_nj7fA',
                                                                   'plBE7mfqzRG03gQL3n4UBw',
                                                                   '6_D8QeQ2FCFM2vWF-jvseQ',
                                                                   'iR3b537ndNGp7Fjf6M1ssg',
                                                                   'jeSBtVyzZ1sGDdSDB2Nqyw',
                                                                   'lk69FV78gL25Gp71MZFzFQ',
                                                                   'N__pLD26scz-GRnzgXNiCg',
                                                                   'nUiMyCjYvbXvDg3CBFpE2Q',
                                                                   'ZH0OnSKSOq3kVKpfLjPmzw',
                                                                   '23NwM0rU7FESoYtvR9KwRg',
                                                                   'UggUpylkigOE8ZYiX2VENQ',
                                                                   'zqhaZe9Nd0fRPimOoiYdzA',
                                                                   'ApRbVjWyAqAVFPefTLrZoQ',
                                                                   'gNmWgMJjd_QntFBRND2r3w',
                                                                   'RNmX7dhUThe0zNtfN9kzIA',
                                                                   'XLIFaJTIVpAWgToOIiLKmQ',
                                                                   'qWf07kJCWUpvEe7-GNROLQ',
                                                                   'xpcJ6ABw4yoz4qLipDIkeg',
                                                                   'qrYUr9zj59t5csIv30qv7w',
                                                                   'mVlr9b3L3MWX2JD8GYtRmA',
                                                                   'JRhpBCPgBq9ORHRaQj1gGA',
                                                                   'ITDnrN4fmd9aSmGBytpOVA',
                                                                   'ZhOANc7XlVP20Jcp53N4Gw',
                                                                   'ruATaByZAE0Vl6fLRVb0fw',
                                                                   'hexAkBNzS_L6-6rDX67faQ',
                                                                   'I13MZ0TwwPHbQ2SkA5qQ0g',
                                                                   'F1HnUUaAvo_skt3PtS2e8g',
                                                                   'qv3udgDrFmsuYC5DkX4oRg',
                                                                   'uJcFyGOeHkfxhNqMG5NLqg',
                                                                   'auSvhRLIWVq_3Q6xPrS-Vw',
                                                                   'cm5OSNHki5vTSPiYd5Hymw',
                                                                   'EzimoALb-6Z7zFIkyBFSww',
                                                                   'bJlbZ2n5G3wxQ_nh2CYNhw',
                                                                   'a0BZL6agnLJR1DbjiXMp7Q',
                                                                   'VGP36NFedUTHLPW_pD52Rg',
                                                                   'Ct6nj9oBEZ9p-24nvS2uvQ',
                                                                   'vc6DilDAGnB34_ULQyVfXQ',
                                                                   'G_AKAgQIzPp0otTcDWPW-Q',
                                                                   'c087QJ_STLC-lT2vHLaj_A',
                                                                   'zVvK5nBRxgHfwQzOf21VhQ',
                                                                   'QjqPqD0gnLsDw3WUDNSM_w',
                                                                   '9zttF7hHAFwzGklK2U-BhQ',
                                                                   'Kt1wk6XGCSK0JNgU24rmfw',
                                                                   '4XLzw3DeQO72fejOuZ_QiA',
                                                                   'Ni0VZ6gay_6c1xQrOmcjnw']
    assert data.get_friends_by_user_id("ITb61jq8zJZiXoZYB5wK2Q"), ['MQnhILGY3p4ptpmKytq0PA',
                                                                   'bD2mQE0AFv8At9IFUfuXwA',
                                                                   '-VzKNDa6_Jxw7GBjYBAc3g']


def test_pivot_stars_newest_review():
    df = data.pivot_stars("faketown")
